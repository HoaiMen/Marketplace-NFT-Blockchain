    ...
    <DefaultLayout>
      <Container maxW={'full'} px="12">
        ...
        >
          ...
          <Box display="flex" flex="1" flexDirection="column" marginTop={{ base: '3', sm: '0' }}>
            ...
            <Text as="p" color={useColorModeValue('gray.700', 'gray.200')} fontSize="lg" mb="-1">
              ...
              <List spacing={2}>
                ...
                <ListItem>
                  <HStack>
                    ...
                    <Rating rating="4.5" numReviews="78" />
                  </HStack>
                </ListItem>
                <ListItem>
                  <Text as={'span'} fontWeight={'bold'}>
