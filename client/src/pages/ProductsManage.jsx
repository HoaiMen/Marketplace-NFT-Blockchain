                    ...
                    >
                        <TableContainer w={'full'} border='1px' borderColor='gray.300'>
                            <Table variant='simple'>
                                <Thead bg={'green.100'}>
                                    <Tr>
                                        <Th><Heading fontSize='xl' alignContent={'center'} color='blue.500'>Thông tin Account</Heading></Th>
                                    </Tr>
                                </Thead>
                                <Tbody>
                                    <Tr>
                                    ...
                                    <Tr>
                                        <Td>
                                            <VStack alignItems='start'>
                                                ...
                                                <Text fontWeight='medium' color='green.400'>Cập nhật lần cuối lúc: 23/1/2023</Text>
                                            </VStack>
                                        </Td>
                                    </Tr>
                                    <Tr>
                    ...
                    <Box
                        ...
                        <TableContainer border='1px' borderColor='gray.300'>
                            <Table variant='simple' >
                                <Thead bg={'green.100'}>
                                    <Tr>
                                        <Th><Heading fontSize='xl' alignContent={'center'} color='blue.500'>Quản lý số dư</Heading></Th>
                                    </Tr>
                                </Thead>
                                <Tbody>
                                    <Tr>
